...
public class Proponente extends javax.swing.JFrame {
   ...
   private static final String PROPERTIES_FILE = "labels.properties";
    ...
    private void initComponents() {
        ...
        jButton7.setText("STATS");
        jButton7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Aliado_Prop aliado_Prop= new Aliado_Prop();
                aliado_Prop.setVisible(true);
                aliado_Prop.setLocationRelativeTo(null);
            }
        });

        jButton8.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        jButton8.setText("CARGAR PROPUESTA");
        ...
        jButton9.setText("SUBIR PROPUESTA");
